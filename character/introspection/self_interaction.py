...
from character.utils import gen_args, get_model_family, get_model_display_name
...
def interaction(
    ...
    mml = 8192 if "llama-3.1-8b" in model.lower() or "Llama-3.1-8B" in model else 16384
    args = gen_args(
        model,
        max_num_seqs = 1024,
    ...
    system_prompt = system.format(NAME=name, TRAITS=trait_string, guidance=guidance)
